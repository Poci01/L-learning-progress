...
- [ ] **1.1 Mini Task:** Buat fungsi `konversi_grade(nilai)` menggunakan `if-elif-else`.
...
- [ ] **2.2 Mini Task:** Buat fungsi generator dengan opsi boolean `pakai_angka` dan `pakai_simbol`.
